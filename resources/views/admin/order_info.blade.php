        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="content">
                    ...
                    <span>Сумма: {{ number_format($product->price_opt * $order->count, 0, ',' , ' ') }}p</span><br/>
                    ...
                    <table class="table table-responsive">
                        ...
                        <tbody class="tbody-cart">
                            <tr align="center">
                                ...
                                <td>{{ $order->count }}</td>
                                <td data-th="Subtotal" class="text-center">{{ number_format($product->price_opt * $order->count, 0, ',', ' ') }}p</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
