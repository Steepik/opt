    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <hr/>
                <form action="{{ route('brand-view-percent') }}" method="GET">
                    <div class="content">
                        <h3>Установить процент для бренда</h3>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <table class="table table-responsive">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-default btn-fill percent_brand" data-userId="{{ $user->id }}" data-toggle="modal" data-target="#accessBrand">Просмотр</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="accessBrand" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('percent-brand-store') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="col-md-6">
                        <input type="number" name="percent_value" class="form-control" placeholder="Процент" required>
                        </div>
                        </div>
                        <input type="hidden" name="user_id" value="" id="userId"><br/>
                    </div>
                ...
                <hr/>
                <h5 class="text-center">Список брендов с применением %</h5>
                <div class="row">
                    <div class="col-md-12">
